      ...
      <div className="landing-card">
        <div className="landing-card-header">
          <div className="landing-logo">
            ...
            <span className="landing-logo-text">connect</span>
          </div>
          <div className="heading">
            <h1>Where question <br /> connect us all</h1>
          </div>
          <p className="landing-subtitle">Join a community of curious minds asking, answering, and discovering together.</p>
        </div>

        <div className="landing-card-body">
          <h3 className="join-title">Join now</h3>
