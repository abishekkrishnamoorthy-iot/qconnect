...
const QuestionForm = forwardRef(({ onSuccess, onError, cudetails, initialState, onStateChange }, ref) => {
  ...
  useImperativeHandle(ref, () => ({
    focus: () => {
      const firstInput = document.querySelector('.question-form input[type="text"]')
  ...
  }, [questionText, details, topic, media, mediaPreviews, visibility, postedTo, selectedGroupId, onStateChange])
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMsg = err.message || 'Failed to post question'
      setError(errorMsg)
      if (onError) {
        onError(errorMsg)
      }
  ...
  return (
    <form onSubmit={handleSubmit} className="question-form create-form">
      ...
      <div className="create-form-group">
        <label htmlFor="question-visibility">Visibility</label>
        <select
